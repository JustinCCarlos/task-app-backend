...
public class TaskRecurrenceImpl implements TaskRecurrenceService {
    ...
    public void generateNextTask(TaskRecurrenceDto recurrenceDto, RecurrencePatternDto patternDto) {
        try{
            ...
            LocalDateTime nextStartDate = calculator.calculateNextStartDate(taskRecurrence.getRecurrenceStartDate(), taskRecurrence, pattern);
            LocalDateTime nextEndDate = calculator.calculateNextEndDate(currentTask.getStartDate(), taskRecurrence, nextStartDate, pattern);
